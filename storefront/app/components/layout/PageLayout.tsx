...
// cart components
import { CartAsideFooter } from '../cart/aside/components/CartAsideFooter';
import { CartAsideHeader } from '../cart/aside/components/CartAsideHeader';
...
function CartAside({ cart }: { cart: PageLayoutProps['cart'] }) {
  return (
    <Suspense fallback={<p>Loading cart ...</p>}>
      <Await resolve={cart}>
        {(cartData) => {
          const optimisticCart = useOptimisticCart(cartData);
          ...
          return (
            <AsideComponent
              ...
              header={
                <CartAsideHeader 
                  heading={cartHasItems ? `Cart (${itemCount})` : 'Cart'}
                />
              }
              footer={
                cartHasItems ? (
                    <CartAsideFooter cart={optimisticCart} layout="aside" />
                ) : null
              }
            >
